        ...
        <section id="main-two">
            ...
            <div id="main-two-1">
                <a href="#" target="_parent"> <!--@@@-->
                    <img src="./pic.png" class="img-fluid">
                </a>
            </div>
            <div id="main-two-1">
                ...
                <div style="width: 70%; height: 100%;">
                    ...
                    <div class="col text-center" style="width: 100%; color: rgb(151, 151, 151);">
                        ...
                        <div style="display: flex; justify-content: center; align-items: center;">
                            <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-google" viewBox="0 0 16 16">
                            ...
                            <a style="width: 30px;"></a>
                            <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-geo-alt" viewBox="0 0 16 16">
