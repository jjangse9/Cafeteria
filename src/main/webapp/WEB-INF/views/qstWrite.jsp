...
<input name="mem_id" class="form-control" placeholder="업체명을 입력해주세요" type="text"/>
                            ...
                            <div class="form-group input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"> <a style="color: red;">*</a><a>사업자등록번호</a> </span>
                                </div>
<!-- 20220121 보낼 데이터 - 2. 사업자 등록번호 -->
<input name="mem_bcode" class="form-control" placeholder="사업자등록번호를 입력해주세요" type="text"/>
                            </div>
                            <div style="width: 100%; height: 15px;"></div>
                            <!--주소지-->
                            <div class="form-group input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"> <a style="color: red;">*</a><a>주소지</a> </span>
                                </div>
<!-- 20220121 보낼 데이터 - 3. 주소지 -->                                
<input name="bmem_address" class="form-control" placeholder="Full name" type="text"/>
                            </div>
                            <div style="width: 100%; height: 15px;"></div>
                            <!--영업시간-->
                            <div class="form-group input-group">
...
<!-- 20220121 보낼 데이터 - 7. 대표이미지 -->
								<span class="input-group-text"> <a>대표이미지</a> </span>
                                </div>
...
<input type="radio" id="e-agree" name="1" value="동의">
                                        <label for="e-agree">동의</label>
                                    </div>
                                    <div style="width: 100px;"></div>
                                    <div>
<input type="radio" id="e-rejection" name="1" value="거부">
